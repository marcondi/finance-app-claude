...
const [filtroAgenda, setFiltroAgenda] = useState('dia');
...
<div className="flex gap-2 mb-3">
  <button onClick={() => setFiltroAgenda('dia')} className="px-3 py-1 bg-blue-600 text-white rounded">
    Dia
  </button>
  <button onClick={() => setFiltroAgenda('semana')} className="px-3 py-1 bg-blue-600 text-white rounded">
    Semana
  </button>
  <button onClick={() => setFiltroAgenda('mes')} className="px-3 py-1 bg-blue-600 text-white rounded">
    Mês
  </button>
</div>
...
const url =
  filtroAgenda === 'dia'
    ? `https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=${inicioDia.toISOString()}&timeMax=${fimDia.toISOString()}`
    : filtroAgenda === 'semana'
    ? `https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=${inicioSemana.toISOString()}&timeMax=${fimSemana.toISOString()}`
    : `https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=${inicioMes.toISOString()}&timeMax=${fimMes.toISOString()}`;
